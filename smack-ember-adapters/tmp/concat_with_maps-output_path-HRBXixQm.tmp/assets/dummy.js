...
define('dummy/models/package', ['exports', 'smack-ember-adapters/models/package'], function (exports, _smackEmberAdaptersModelsPackage) {
  Object.defineProperty(exports, 'default', {
    enumerable: true,
    get: function get() {
      return _smackEmberAdaptersModelsPackage['default'];
    }
  });
});
...
if (!runningTests) {
  require("dummy/app")["default"].create({"LOG_ACTIVE_GENERATION":false,"LOG_VIEW_LOOKUPS":false,"rootElement":"#ember-testing","name":"smack-ember-adapters","version":"1.0.0+cd06e653"});
}
