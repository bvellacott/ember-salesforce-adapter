...
define('dummy/tests/integration/adapters/ls-adapter-test', ['exports', 'dummy/tests/helpers/store', 'ember', 'dummy/tests/helpers/fixtures', 'ember-data', 'smack-ember-adapters/adapters/ls-adapter', 'qunit'], function (exports, _dummyTestsHelpersStore, _ember, _dummyTestsHelpersFixtures, _emberData, _smackEmberAdaptersAdaptersLsAdapter, _qunit) {
  ...
  (0, _qunit.test)('deleteRecord', function (assert) {
    ...
    var assertListIsDeleted = function assertListIsDeleted() {
      ...
      return store.query('list', 'where name = "one"' /*{name: 'one'}*/).then(function (records) {
...
define('dummy/tests/integration/adapters/smack-models-test', ['exports', 'dummy/tests/helpers/store', 'ember', 'dummy/tests/helpers/smack-model-fixtures', 'ember-data', 'smack-ember-adapters/adapters/ls-adapter', 'smack-ember-adapters/adapters/smackHooks', 'smack-ember-adapters/models/connection', 'smack-ember-adapters/models/package', 'smack-ember-adapters/models/compilation-unit', 'smack-ember-adapters/models/execute-event', 'smack-ember-adapters/models/execute-anonymous-event', 'smack-ember-adapters/models/test-datum', 'qunit'], function (exports, _dummyTestsHelpersStore, _ember, _dummyTestsHelpersSmackModelFixtures, _emberData, _smackEmberAdaptersAdaptersLsAdapter, _smackEmberAdaptersAdaptersSmackHooks, _smackEmberAdaptersModelsConnection, _smackEmberAdaptersModelsPackage, _smackEmberAdaptersModelsCompilationUnit, _smackEmberAdaptersModelsExecuteEvent, _smackEmberAdaptersModelsExecuteAnonymousEvent, _smackEmberAdaptersModelsTestDatum, _qunit) {
  var run = _ember['default'].run;
  var get = _ember['default'].get;
  var set = _ember['default'].set;
  ...
  (0, _qunit.module)('smack model hooks', {
    beforeEach: function beforeEach() {
      ...
      env = (0, _dummyTestsHelpersStore['default'])({
        ...
        'package': _smackEmberAdaptersModelsPackage['default'],
  ...
  (0, _qunit.test)('package create and delete', function (t) {
    t.expect(7);
    var done = t.async();

    var parentPack = run(store, 'createRecord', 'package', { name: 'parent' });

    run(parentPack, 'save').then(function () {
      t.ok(parentPack.id, 'parent package has an id');
      t.ok(_smackEmberAdaptersAdaptersSmackHooks['default'].getPackNamespace('parent'), 'parent package created in the namespace');
      var childPack = run(store, 'createRecord', 'package', { name: 'child' });
      childPack.set('parent', parentPack);

      run(childPack, 'save').then(function () {
        t.ok(childPack.id, 'child package has an id');
        t.ok(_smackEmberAdaptersAdaptersSmackHooks['default'].getPackNamespace('parent.child'), 'child package created in the namespace');
        var grandChildPack = run(store, 'createRecord', 'package', { name: 'grandChild' });
        grandChildPack.set('parent', childPack);

        run(grandChildPack, 'save').then(function () {
          t.ok(grandChildPack.id, 'grand child package has an id');
          t.ok(_smackEmberAdaptersAdaptersSmackHooks['default'].getPackNamespace('parent.child.grandChild'), 'grandChild package created in the namespace');
          run(parentPack, 'destroyRecord').then(function () {
            run(store, 'findAll', 'package').then(function (packs) {
  ...
  (0, _qunit.test)('compilation-unit create, update and delete', function (t) {
    ...
    run(mathPack, 'save').then(function () {
      var mathSumsPack = run(store, 'createRecord', 'package', { name: 'sums' });
      mathSumsPack.set('parent', mathPack);
      run(mathSumsPack, 'save').then(function () {
        var unit = run(store, 'createRecord', 'compilation-unit', { name: 'sum', pack: mathPack, source: 'func add(a, b) { ret a + b; } func sub(a, b) { ret a - b; }' });
        run(unit, 'save').then(function () {
          ...
          run(unit, 'save').then(function (unit) {
            ...
            t.equal(typeof _smackEmberAdaptersAdaptersSmackHooks['default'].getFuncNamespace('math.sums').add, 'function', 'add function moved to the math.sums namespace');
            t.equal(typeof _smackEmberAdaptersAdaptersSmackHooks['default'].getFuncNamespace('math.sums').sub, 'undefined', 'sub function not copied over to the math.sums namespace');
            ...
            run(unit, 'save').then(function () {
              ...
              t.equal(typeof _smackEmberAdaptersAdaptersSmackHooks['default'].getFuncNamespace('math.sums').add, 'undefined', 'add function removed from the math namespace');
              done();
            });
          });
        });
...
define('dummy/tests/unit/models/compilation-unit-test', ['exports', 'ember-qunit', 'ember', 'smack-ember-adapters/adapters/smackHooks'], function (exports, _emberQunit, _ember, _smackEmberAdaptersAdaptersSmackHooks) {
  ...
  (0, _emberQunit.test)('beforeCreate - hook', function (t) {
    _smackEmberAdaptersAdaptersSmackHooks['default'].setNamespace({ math: { _f: {} } });
    var model = { name: 'sum', pack: 'p', source: 'func add(a, b) { ret a + b; } func sub(a, b) { ret a - b; }' };
    var hash = { 'package': { records: {
          'p': { name: 'math' }
        } } };

    run(_smackEmberAdaptersAdaptersSmackHooks['default'], 'beforeCreate', hash, { modelName: 'compilation-unit' }, model);
  ...
  (0, _emberQunit.test)('beforeDelete - hook', function (t) {
    _smackEmberAdaptersAdaptersSmackHooks['default'].setNamespace({ math: { _f: {} } });
    var model = { id: '1', name: 'sum', pack: 'p', source: 'func add(a, b) { ret a + b; } func sub(a, b) { ret a - b; }' };
    var hash = {
    ...
    run(_smackEmberAdaptersAdaptersSmackHooks['default'], 'beforeDelete', hash, { modelName: 'compilation-unit' }, model);
    t.equal(typeof _smackEmberAdaptersAdaptersSmackHooks['default'].getFuncNamespace('math').add, 'undefined', 'add function removed from the math namespace');
    t.equal(typeof _smackEmberAdaptersAdaptersSmackHooks['default'].getFuncNamespace('math').sub, 'undefined', 'sub function removed from the math namespace');
    _smackEmberAdaptersAdaptersSmackHooks['default'].setNamespace({});
  });
  ...
  (0, _emberQunit.test)('beforeUpdate - hook', function (t) {
    _smackEmberAdaptersAdaptersSmackHooks['default'].setNamespace({ math: { _f: {} }, mathematics: { _f: {} } });
    var model = { id: '1', name: 'sum', pack: 'p1', source: 'func add(a, b) { ret a + b; } func sub(a, b) { ret a - b; }' };
    var hash = {
    ...
    run(_smackEmberAdaptersAdaptersSmackHooks['default'], 'beforeUpdate', hash, { modelName: 'compilation-unit' }, model);
...
define('dummy/tests/unit/models/package-test', ['exports', 'ember-qunit'], function (exports, _emberQunit) {
