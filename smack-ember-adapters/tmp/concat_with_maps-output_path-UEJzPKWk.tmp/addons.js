  ...
  var form = {
    toStorageForm: function toStorageForm(store, type, record) {
      ...
      type.eachRelationship(function (name, desc) {
        ...
        if (!inverseDesc || !inverseDesc.name || inverseDesc.name === '' || inverseDesc.kind === 'hasMany') throw 'no belongsTo/hasOne inverse is defined in the model: ' + desc.type + ' for the has many relationship: ' + name + ' in the model: ' + type.modelName;
