...
var LSAdapter = DS.Adapter.extend(Ember.Evented, {
  /**
  ...
  createRecord: function createRecord(store, type, snapshot) {
    ...
    try {
      SmackHooks.beforeCreate(store, type, snapshot);
    } catch (e) {
    ...
    try {
      SmackHooks.afterCreate(store, type, snapshot);
    } catch (e) {
  ...
  deleteRecord: function deleteRecord(store, type, snapshot) {
    ...
    try {
      SmackHooks.beforeDelete(store, type, snapshot);
    } catch (e) {
    ...
    this.persistData(type, namespaceRecords);
    try {
      SmackHooks.afterDelete(store, type, snapshot);
    } catch (e) {
