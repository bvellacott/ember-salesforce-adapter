define('dummy/tests/unit/models/compilation-unit-test', ['exports', 'ember-qunit', 'ember', 'smack-ember-adapters/adapters/smackHooks'], function (exports, _emberQunit, _ember, _smackEmberAdaptersAdaptersSmackHooks) {
  ...
  (0, _emberQunit.test)('beforeCreate - hook', function (t) {
    ...
    t.equal(typeof _smackEmberAdaptersAdaptersSmackHooks['default'].getPackNamespace('math').add, 'function', 'add function created in the math namespace');
    t.equal(typeof _smackEmberAdaptersAdaptersSmackHooks['default'].getPackNamespace('math').sub, 'function', 'sub function created in the math namespace');

    delete _smackEmberAdaptersAdaptersSmackHooks['default'].getPackNamespace('math').add;
    delete _smackEmberAdaptersAdaptersSmackHooks['default'].getPackNamespace('math').sub;
  });
  ...
  (0, _emberQunit.test)('beforeDelete - hook', function (t) {
    ...
    t.equal(typeof _smackEmberAdaptersAdaptersSmackHooks['default'].getPackNamespace('math').add, 'undefined', 'add function removed from the math namespace');
    t.equal(typeof _smackEmberAdaptersAdaptersSmackHooks['default'].getPackNamespace('math').sub, 'undefined', 'sub function removed from the math namespace');
  });
  ...
  (0, _emberQunit.test)('beforeUpdate - hook', function (t) {
    ...
    t.equal(typeof _smackEmberAdaptersAdaptersSmackHooks['default'].getPackNamespace('math').add, 'function', 'add function still in the math namespace');
    t.equal(typeof _smackEmberAdaptersAdaptersSmackHooks['default'].getPackNamespace('math').sub, 'undefined', 'sub function removed from the math namespace');
    ...
    t.equal(typeof _smackEmberAdaptersAdaptersSmackHooks['default'].getPackNamespace('math').add, 'undefined', 'add function removed from the math namespace');
    t.equal(typeof _smackEmberAdaptersAdaptersSmackHooks['default'].getPackNamespace('mathematics').add, 'function', 'add function created in the mathematics namespace');

    delete _smackEmberAdaptersAdaptersSmackHooks['default'].getPackNamespace('mathematics').add;
  });
});