...
define('smack-ember-adapters/adapters/ls-adapter', ['exports', 'ember', 'ember-data', 'npm:where-clause-evaluate', 'smack-ember-adapters/adapters/smackHooks'], function (exports, _ember, _emberData, _npmWhereClauseEvaluate, _smackEmberAdaptersAdaptersSmackHooks) {
  ...
  var LSAdapter = _emberData['default'].Adapter.extend(_ember['default'].Evented, {
    ...
    findRecord: function findRecord(store, type, id, opts) {
      ...
      try {
        _smackEmberAdaptersAdaptersSmackHooks['default'].onFind(store, type, record, allowRecursive);
      } catch (e) {
    ...
    findMany: function findMany(store, type, ids, opts) {
      ...
      for (var i = 0; i < ids.length; i++) {
        ...
        try {
          _smackEmberAdaptersAdaptersSmackHooks['default'].onFind(store, type, res, record);
        } catch (e) {
    ...
    query: function query(store, type, _query /*recordArray*/) {
      ...
      try {
        _smackEmberAdaptersAdaptersSmackHooks['default'].onQuery(store, type, results, allowRecursive);
      } catch (e) {
        return _ember['default'].RSVP.reject(new Error("On find hook failed on: " + " type '" + type.modelName + "'.\n\n" + e));
      }
      var res;
    ...
    findAll: function findAll(store, type) {
      ...
      try {
        _smackEmberAdaptersAdaptersSmackHooks['default'].onFindAll(store, type, namespace.records);
      } catch (e) {
        return _ember['default'].RSVP.reject(new Error("On find hook failed on: " + " type '" + type.modelName + "'.\n\n" + e));
      }
    ...
    createRecord: function createRecord(store, type, snapshot) {
      ...
      try {
        _smackEmberAdaptersAdaptersSmackHooks['default'].beforeCreate(store, type, recordHash);
      } catch (e) {
      ...
      try {
        _smackEmberAdaptersAdaptersSmackHooks['default'].afterCreate(store, type, recordHash);
      } catch (e) {
    ...
    updateRecord: function updateRecord(store, type, snapshot) {
      ...
      try {
        _smackEmberAdaptersAdaptersSmackHooks['default'].beforeUpdate(store, type, recordHash);
      } catch (e) {
      ...
      this.persistData(type, namespaceRecords);
      try {
        _smackEmberAdaptersAdaptersSmackHooks['default'].afterUpdate(store, type, recordHash);
      } catch (e) {
    ...
    deleteRecord: function deleteRecord(store, type, snapshot) {
      ...
      try {
        _smackEmberAdaptersAdaptersSmackHooks['default'].beforeDelete(store, type, recordHash);
      } catch (e) {
      ...
      this.persistData(type, namespaceRecords);
      try {
        _smackEmberAdaptersAdaptersSmackHooks['default'].afterDelete(store, type, recordHash);
      } catch (e) {
...
define('smack-ember-adapters/adapters/smackHooks', ['exports', 'npm:smack-js-compiler'], function (exports, _npmSmackJsCompiler) {
	...
	var beforeCreateHandlers = {
		...
		'package': function _package(packageRec) {
...
define('smack-ember-adapters/models/compilation-unit', ['exports', 'ember-data/model', 'ember-data/attr', 'ember-data/relationships'], function (exports, _emberDataModel, _emberDataAttr, _emberDataRelationships) {
	...
	exports['default'] = _emberDataModel['default'].extend({
		...
		pack: (0, _emberDataRelationships.belongsTo)('package'),
