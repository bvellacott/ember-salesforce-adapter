...
define('smack-ember-adapters/adapters/ls-adapter', ['exports', 'ember', 'ember-data', 'npm:where-clause-evaluate', 'smack-ember-adapters/adapters/smackHooks'], function (exports, _ember, _emberData, _npmWhereClauseEvaluate, _smackEmberAdaptersAdaptersSmackHooks) {
  ...
  var LSAdapter = _emberData['default'].Adapter.extend(_ember['default'].Evented, {
    ...
    createRecord: function createRecord(store, type, snapshot) {
      ...
      try {
        _smackEmberAdaptersAdaptersSmackHooks['default'].beforeCreate(store, type, snapshot);
      } catch (e) {
      ...
      try {
        _smackEmberAdaptersAdaptersSmackHooks['default'].afterCreate(store, type, snapshot);
      } catch (e) {
    ...
    updateRecord: function updateRecord(store, type, snapshot) {
      ...
      try {
        _smackEmberAdaptersAdaptersSmackHooks['default'].beforeUpdate(store, type, snapshot);
      } catch (e) {
        return _ember['default'].RSVP.reject(new Error("Before update hook failed on: " + " type '" + type.modelName + "' for the id '" + id + "'.\n\n" + e));
      }
      this.persistData(type, namespaceRecords);
      try {
        _smackEmberAdaptersAdaptersSmackHooks['default'].afterUpdate(store, type, snapshot);
      } catch (e) {
    ...
    deleteRecord: function deleteRecord(store, type, snapshot) {
      ...
      try {
        _smackEmberAdaptersAdaptersSmackHooks['default'].beforeDelete(store, type, snapshot);
      } catch (e) {
      ...
      this.persistData(type, namespaceRecords);
      try {
        _smackEmberAdaptersAdaptersSmackHooks['default'].afterDelete(store, type, snapshot);
      } catch (e) {
